...
from openff.qcsubmit.results.filters import (
    CMILESResultFilter,
    ConnectivityFilter,
    ElementFilter, RecordStatusFilter,
    SMILESFilter,
)
...
@click.argument(
    ...
    nargs=1,
    type=click.STRING,
    default="OpenFF Industry Benchmark Season 1 v1.1",
)
def main(data_set):
    ...
    * "OpenFF Industry Benchmark Season 1 v1.0"
    ...
    `industry-benchmark-opt-set-processed.json`.
    """
    ...
    result_collection = OptimizationResultCollection.parse_file(
        'industry-benchmark-set-result-collection-downloaded.json')
